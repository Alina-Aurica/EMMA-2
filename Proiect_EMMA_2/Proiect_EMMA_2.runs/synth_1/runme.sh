...
HD_PWD='D:/Facultate/ANUL 3/ANUL 3 - Semestrul 1/SSC/Proiect/Proiect_EMMA_2/Proiect_EMMA_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Emma_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Emma_2.tcl
